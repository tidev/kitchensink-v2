...
exports.parse = function (node, state) {
	...
	if (height || width) {
		...
		if (height && !contentwin.hasAttribute('height')) {
			contentwin.setAttribute('height', height);
		}
		if (width && !contentwin.hasAttribute('width')) {
			contentwin.setAttribute('width', width);
		}
	}
